    ...
    public void unenrollTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.ID),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("banka1@usc.edu"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.Password),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("banka1"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.courseEnrollmentTextView), withText("Enrolled: 4"),
                        ...
                        isDisplayed()));
        textView.check(matches(withText("Enrolled: 4")));
