...
public class SeeRosterProfile {
    ...
    public void seeRosterProfile() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.name), withText("Gauri Shahra"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class))),
                        isDisplayed()));
        textView.check(matches(withText("Gauri Shahra")));
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.pName), withText("Gauri Shahra"),
                        withParent(allOf(withId(R.id.profileName),
                                withParent(withId(R.id.profile)))),
                        isDisplayed()));
        textView2.check(matches(withText("Gauri Shahra")));
